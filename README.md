...
- 应援站共七幕：入场、人物、应援、灯光、幕后、未拆信件与安可。按钮、键盘方向键、PageUp/PageDown、滚轮和移动端纵向滑动均可翻页。
...
页面刻意不让 3D 人物每幕都站在正中央：入场、灯光控制和安可是明确的 3D 舞台；人物资料与幕后章节把 WebGL 画面降成模糊、低亮背景；应援和未拆信件章节直接隐藏 3D 人物，用官网新年/情人节视觉、角色立绘、切片、遮挡条和证据标签承担主画面。图片、巨大文字、跑马灯和 3D 舞台共享同一个固定层级，而不是左右分栏的“模型展示 + 说明文字”。
